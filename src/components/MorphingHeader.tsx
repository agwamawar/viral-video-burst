...
const MorphingHeader = () => {
  ...
  return (
    <div className="flex items-center justify-center text-center mb-8 px-4 max-w-3xl mx-auto">
      <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif tracking-tight leading-tight">
        Let's Make Your
        <span 
          className={`inline-block mx-2 w-24 md:w-32 text-center font-serif text-primary transition-all duration-600 ease-in-out ${
